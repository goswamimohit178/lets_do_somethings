...
import 'package:lets_do_somethings/Api%20Services/bussiness_view_api/get_bussiness_details_api.dart';
...
class BussinessDetails extends StatefulWidget {
  ...
  BussinessDetails(this.COMPANY_NAME, this.BUSSINESS_ID, {Key? key})
      : super(key: key);
  @override
...
class _BussinessDetailsState extends State<BussinessDetails> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          bussiness_details!["vBusinessDetail"]
                                      ["BusinessDescription"] !=
                                  null
                              ? Text(
                                  bussiness_details!["vBusinessDetail"]
  ...
  Future<BussinessDetailsResponse> getBussinessDetails(
      BuildContext context, String BusinessUserId) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String AUTHTOKEN = prefs.getString('access_token')!;
    String TOKENTYPE = prefs.getString('token_type')!;
    String url =
        '${ApiConstants.BASE_URL + ApiConstants.GET_BUSSINESS_DETAILS + "?BId=$BusinessUserId"} ';
